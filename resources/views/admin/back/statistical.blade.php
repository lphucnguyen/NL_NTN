...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            ...
            <hr>
            @endif
            <div {{-- /Sản phẩm gần hết --}} <div class="row x_title">
                <div class="col-md-6">
                    <h3>
                        <small class="fs-6">
                    ...
                    <tbody>
                        @foreach ($order_detail as $v)
                            <tr class="even pointer text-center">
                                ...
                                <td class=" last">
                                    <a href="javascript:;" onclick="showPD({{ $v->product_id }})" data-bs-toggle="modal"
                                        data-bs-target="#viewProductDetail">Xem sản phẩm</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
