            ...
            <form wire:submit.prevent="submitReview" class="w-full">
                ...
                <div class="row p-b-25">
                    ...
                    <div class="col-sm-6 p-b-5">
                        ...
                        <input disabled class="size-111 bor8 stext-102 cl2 p-lr-20" id="name" type="text" name="name">
                    </div>

                    <div class="col-sm-6 p-b-5">
                        <label class="stext-102 cl3" for="email">Email</label>
                        <input disabled class="size-111 bor8 stext-102 cl2 p-lr-20" id="email" type="text" name="email">
                    </div>
                </div>
